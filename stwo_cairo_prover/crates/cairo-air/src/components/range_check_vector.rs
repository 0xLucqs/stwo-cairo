...
generate_range_check_constraints!([19], b, B);
generate_range_check_constraints!([19], c, C);
generate_range_check_constraints!([19], d, D);
generate_range_check_constraints!([19], e, E);
generate_range_check_constraints!([19], f, F);
generate_range_check_constraints!([19], g, G);
generate_range_check_constraints!([19], h, H);
